...
int main(int argc, char *argv[])
{
	...
	if(argc!=6){
	    ...
	    printf(BOLDGREEN "\t[3]" RESET ": SA - Inital Temperature;\n");
	    printf(BOLDGREEN "\t[4]" RESET ": SA - Cooling factor\n");
	...
	EjectionChain *h_ejection = allocationPointerEjectionChain(h_instance); //deve sair
